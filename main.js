...
function setJoystick(){
    window.joystick = new JoyStick('joyDiv',{
        ...
        console.log(window.armbase2.object._y)
        console.log(stickData.xPosition);
        // if (stickData.xPosition > 100) {
            window.armbase2.setValue(window.armbase2.object._y+(stickData.xPosition-0.5)*0.02) 
        // } else {
            if(stickData.xPosition >= 100) {
                window.armbase2.setValue(window.armbase2.object._y-(stickData.xPosition)*0.02)
            }
        //     window.armbase2.setValue(window.armbase2.object._y-(stickData.xPosition)*0.2)
        // }
        console.log(window.armbase2.object._y+(stickData.xPosition*-1)*0.2);
